...
const Key = tw.div`font-medium text-indigo-700`;

const PrimaryButton = tw(PrimaryButtonBase)`mt-8 md:mt-10 text-sm inline-block mx-auto md:mx-0`;

const DecoratorBlob = styled(SvgDotPattern)(props => [
  tw`w-20 h-20 absolute right-0 bottom-0 transform translate-x-1/2 translate-y-1/2 fill-current text-indigo-500 z-10`
]);
...
export default ({
  ...
  heading = (
    <>
      We have been doing this <wbr /> since <span tw="text-indigo-500">1999.</span>
    </>
  ),
