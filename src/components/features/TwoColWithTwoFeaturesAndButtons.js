...
const FeatureIconContainer = styled.div`
  ${tw`mx-auto inline-block border border-indigo-500 text-center rounded-full p-2 flex-shrink-0`}
  svg {
    ${tw`w-5 h-5 text-indigo-500`}
  }
`;

const FeatureText = tw.div`mt-4 md:mt-0 md:ml-4 text-center md:text-left`;
const FeatureHeading = tw.div`font-bold text-lg text-indigo-500`;
...
export default ({
  ...
  heading = (
    <>
      We have the most <span tw="text-indigo-500">professional</span> marketing team.
    </>
  ),
