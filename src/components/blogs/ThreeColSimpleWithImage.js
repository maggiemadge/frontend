...
const Link = tw.a`inline-block mt-2 text-sm text-indigo-500 font-bold cursor-pointer transition duration-300 border-b-2 border-transparent hover:border-indigo-500`;
