...
const Container = tw(ContainerBase)`bg-indigo-900 text-gray-100 -mx-8 px-8`;
...
const ActionButton = styled(PrimaryButtonBase)`
  ${tw`block text-center text-sm font-semibold tracking-wider w-full text-gray-100 bg-indigo-500 px-6 py-4 rounded hover:bg-indigo-700 focus:shadow focus:outline-none transition-colors duration-300`}
`;
